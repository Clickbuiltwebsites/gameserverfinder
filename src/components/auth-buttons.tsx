import { signInWithGoogle, signOutAction, enterDemoMode } from "@/app/actions";

export function SignOutButton({ demo }: { demo: boolean }) {
  return (
    <form action={signOutAction}>
      <button type="submit" className="nav__link" title={demo ? "Leave demo mode" : undefined}>
        Sign out
      </button>
    </form>
  );
    ...
    <form action={signInWithGoogle}>
      <button type="submit" className="btn btn--block">
        <svg width="16" height="16" viewBox="0 0 18 18" aria-hidden="true">
          ...
          <path
            fill="#EA4335"
            d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.59C13.46.9 11.43 0 9 0A9 9 0 0 0 .93 4.95l3.04 2.33C4.68 5.16 6.66 3.58 9 3.58Z"
          />
        </svg>
